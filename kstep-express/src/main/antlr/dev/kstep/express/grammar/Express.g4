// EXPRESS grammar (ISO 10303-11) — vendored from lutaml/express-grammar
// Source: https://github.com/lutaml/express-grammar (commit as of 2026-07-18)
// Original: Copyright (c) 2020 Ribose Inc. — BSD-2-Clause. See /NOTICE for full attribution.
// This comment block is an addition on top of the vendored file; the grammar body below is unmodified.
